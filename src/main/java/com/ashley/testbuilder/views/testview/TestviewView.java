package com.ashley.testbuilder.views.testview;


import com.ashley.testbuilder.views.MainLayout;
import com.ashley.testbuilder.views.testview.ServiceHealth.Status;
...
public class TestviewView extends Main {

    public TestviewView() {
        addClassName("testview-view");
